...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements(){
        val textAction: TextView = findViewById(R.id.text_action)
            ...
            when(lemonadeState) {
            SELECT -> textAction.text = "Click to select a lemon!"
            SQUEEZE -> textAction.text = "Click to juice the lemon!"
            DRINK -> textAction.text = "Click to drink your lemonade!"
            else -> textAction.text = "Click to start again!"
        }
